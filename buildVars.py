...
addon_info = AddonInfo(
	...
	addon_summary=_("malwarebytes windows firewall control"),
	# Add-on description
	# Translators: Long description to be shown for this add-on on add-on information from add-on store
	addon_description=_("improves accessibility of windows firewall control by labelling various controls"),
	# version
	addon_version="0.2",
...
It can span multiple lines."""),
	...
	addon_url="https://github.com/dave090679/fwcui/releases",
	# URL for the add-on repository where the source code can be found
	addon_sourceURL="https://github.com/dave090679/fwcui",
